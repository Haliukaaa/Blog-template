  ...
  return (
    <div className="w-1/2 mx-auto mt-10">
      ...
      <div className="mt-6 flex gap-8">
        <div className="border rounded-xl w-[45%] pt-4 pl-4 pb-4">
      ...
      <div className="bg-gray-100 rounded-lg w-[96%] mt-12 py-7 pl-8 flex flex-col gap-6 pr-28">
        ...
        <div className="flex justify-between">
          <input
            type="text"
            className="rounded-[5px] h-8 border pl-4"
        ...
        <textarea name="message" id="message" cols="30" rows="7" className="rounded-[5px] border resize-none"></textarea>
