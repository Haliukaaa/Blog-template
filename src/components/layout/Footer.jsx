export const Footer = () => {
  return (
    <div className="border-t border-slate-250 mt-6 pt-6 pb-5 flex justify-between items-center">
      <div className="flex gap-3">
        ...
        {/* logo */}
        <div>
            <p className="text-xl">Meta<span className="font-bold">Blog</span></p>
            <p className="text-base text-color">© All Rights Reserved.</p>
        </div>
      </div>
      {/* privacy policy */}
      <div className="flex gap-6 text-color">
        <p className="border-r pr-5">Terms of Use</p>
