            ...
            <div className="w-1/4 flex flex-col gap-7">
              ...
              <div>
                <p className="text-color">
                  <span className="font-bold text-color">Email :</span>{" "}
                  info@jstemplate.net
                </p>
                <p className="text-color">
                  <span className="font-bold text-color">Phone :</span> 880 123
                  456 789
                </p>
              </div>
            </div>
            ...
            <div>
              <ul className="list-none text-color">
                ...
                <Link href={{ pathname: "/AllBlog" }}>
                  {" "}
                  <li className="pt-2 hover:text-yellow-500 hover:scale-105 transition-all">
                    Blog
                  </li>
                </Link>
